...
const App = () => {
  ...
  const postDatas = ({ valueDate, reqTime, valueDateEnd, reqTimeEnd }) => {
    ...
    params.append(
      "sendBaseTime",
      new moment(valueDate).format("YYYY-MM-DDTHH:mm:ss")
    );
    params.append(
      "sendTimeEnd",
      new moment(valueDateEnd).format("YYYY-MM-DDTHH:mm:ss")
    );
  ...
  const getDatasThreeHour = () => {
    const apiUrl = databaseAws + "/threehour";
  ...
  const getDatasTwelveHour = () => {
    const apiUrl = databaseAws + "/twelvehour";
  ...
  const getDatasOneDay = () => {
    const apiUrl = databaseAws + "/oneday";
  ...
  const getDatasThreeDay = () => {
    const apiUrl = databaseAws + "/threeday";
